...
/******/ 	var hotCurrentHash = "70446f18e312036e86b3"; // eslint-disable-line no-unused-vars
...
var ProductCart = function () {
  ...
  _createClass(ProductCart, [{
    key: 'totalProductscalc',
    value: function totalProductscalc() {
      var products = this.products;
      var allProducts = 0;
      $.each(products, function (index, value) {
        var total_products = Number(products[index].product_quantity);
    ...
    value: function addEventListeners() {
      ...
      $('.add_to_cart').click(function (e) {
        ...
        var product_image = $(buttonPressed).children(".good_picture").attr('src');
        var product_id = $(buttonPressed).children("[name='product_id']").val();
        var product_quantity_block = $(buttonPressed).children("[name='product_quantity']");
        ...
        var z = mi.checkDoubles(newProduct);
        mi.addProduct(newProduct, z);
        buttonClicked.innerHTML = "В корзине!";

        setTimeout(function () {
          buttonClicked.innerHTML = "Купить";
        }, 1500);
    ...
    key: 'checkDoubles',
    value: function checkDoubles(newProduct, z) {
      var products = this.products;
      var newProductId = newProduct.product_id;
      for (var _z = 0; _z < products.length; _z++) {
        if (products.length > 0 && products[_z].product_id == newProductId) {
          return _z;
        } //IF     
      } //for 
    } // function
    ...
    key: 'addProduct',
    value: function addProduct(newProduct, z) {
      var products = this.products;
      var newProductQuantity = newProduct.product_quantity;
      if (z >= 0) {
        var product_quantity = Number(products[z].product_quantity) + Number(newProductQuantity);
